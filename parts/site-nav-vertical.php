...
$menu_id = get_post_meta( get_the_ID(), 'wsuwp_medicine_side_nav', true );

if ( ! empty( $menu_id ) ) {

	require_once get_stylesheet_directory() . '/classes/class-menu.php';

	$menu = new WSUWP\Theme\Medicine\Menu();

	$menu->set_menu( array( 'id' => $menu_id ) );
...
<!-- COMPONENT:START -->
<div class="wsu-s-nav-vertical__wrapper wsu-s-nav-vertical__wrapper--start-open wsu-u-no-js">
